...
class MainActivity: FlutterActivity(){
    ...
    override fun configureFlutterEngine(@NonNull flutterEngine: FlutterEngine) {
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, CHANNEL).setMethodCallHandler {
                call, result ->
            Log.e("sdsd",call.method);
            UpiPayPlugin(this,).onMethodCall(call,result)
            ...
            else if(call.method=="getInstalledUpiApps")
            {

               // UpiPayPlugin(Activity()).
                //Log.e("sdsd",call.method+"calling");
                //this.getInstalledUpiApps()
            }
            else{
...
//                else -> result.notImplemented()
    ...
    private fun getInstalledUpiApps() {
        Log.e("paylist","callimeehotd");
        val uriBuilder = Uri.Builder()
        uriBuilder.scheme("upi").authority("pay")

        val uri = uriBuilder.build()
        Log.e("dsa",uri.toString());
        val intent = Intent(Intent.ACTION_VIEW, uri)
        ...
        try {
            ...
            val activityResponse = activities.map {
                ...
                Log.e("paylist",activities.toString())

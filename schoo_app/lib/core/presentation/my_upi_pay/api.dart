...
import 'package:schoo_app/core/presentation/my_upi_pay/applications.dart';
...
import 'package:schoo_app/core/presentation/my_upi_pay/method_channel.dart';
import 'package:schoo_app/core/presentation/my_upi_pay/response.dart';
import 'package:schoo_app/core/presentation/my_upi_pay/status.dart';
import 'package:schoo_app/core/presentation/my_upi_pay/transaction.dart';
...
class UpiPay {
  ...
  static Future<List<ApplicationMeta>> getInstalledUpiApplications({
    ...
    log("app list ${await _discovery.discover(

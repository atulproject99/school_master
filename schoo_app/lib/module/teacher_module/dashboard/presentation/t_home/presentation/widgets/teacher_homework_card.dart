...
class TeacherHomeworkCard extends HookConsumerWidget {
                    ...
                    child: AppButton(
                        ...
                        callback: () {
                          if (homework.pdf == null) {
                            AppSnackBar.showInSnackBar("No Pdf File", context);
                          } else {
                            AutoRouter.of(context)
                                .push(MyPdfViewerRoute(pdfUrl: homework.pdf!));
                          }
                        },
                        buttonWidth: 0.8.sw,
                        borderRadius: 5,
                      ...
                      callback: () {
                        if (homework.videolink == null) {
                          ...
                          AutoRouter.of(context).push(
                              VideoPlayerRoute(videoUrl: homework.videolink!));
                        }
                      },
                      buttonWidth: 0.8.sw,
                      borderRadius: 5,

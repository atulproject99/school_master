...
class PTransportAmountPage extends HookConsumerWidget {
  const PTransportAmountPage(
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final studentFees = useState<TransportAmount?>(null);
    ...
    Future.delayed(const Duration(seconds: 1), () {
      ...
      var lastDue = studentFees.value?.lastdue?.toDouble() ?? 0;
      _totalAmountController.text = " ${feesAmount + lastDue}";
      /*  totalAmpunt.value =
    ...
    ref.watch(getTransportAmount(studentId)).when(
        data: (data) {
    ...
    ref.listen<UpiPaymentState>(upiPaymentProvider, (_, state) {
      state.maybeMap(
        ...
        failure: (d) {
          Navigator.of(context).pop();
          ref.read(transportFeeUpdateProvider.notifier).payTransportAmount(
              context,
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            ref.watch(getTransportAmount(studentId)).when(data: (data) {
              print(data);
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text("₹ ${data.transportFee.toString()}",
                                style: Theme.of(context)
                                    .textTheme
                                    .headline4!
                                    .copyWith(
                    ...
                    children: [
                      Expanded(
                        ...
                        child: AppButton(
                            buttonTitle: "Pay Now",
                            callback: () {
                              if (_totalAmountController.text == "0") {

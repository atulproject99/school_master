...
class NoticePage extends HookConsumerWidget {
  NoticePage({Key? key, required this.studentId}) : super(key: key);
  var list = ["2022-06-14", "2022-06-12"];
  final int studentId;
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    var isLoading = useState<bool>(false);
    var noticeList = useState<List<NoticeData>>([]);
    print(studentId);
    ref.watch(parentNoticeProvider(studentId)).when(data: (data) {
